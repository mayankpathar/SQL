...
SELECT DATEDIFF(MONTH,'2025-03-31','2025-12-31');
...
SELECT DATEDIFF(YEAR,'2008-01-26',GETDATE());
SELECT DATEDIFF(MONTH,'2008-01-26',GETDATE());
...
SELECT MONTH(ADATE),MAX(AMOUNT) FROM DEPOSIT
GROUP BY MONTH(ADATE)
...
SELECT * FROM DEPOSIT
WHERE DAY(ADATE) BETWEEN 31-12-2025 AND  01-03-2025

--27. Display records where account date is in the current year.
SELECT * FROM DEPOSIT
WHERE DAY(ADATE) BETWEEN 01-03-2025 AND  31-12-2025
